...
fn plain() {
    ...
    let _: Q1 = Bld::<Q1, _>::new().push_back(2).finish();
    let _: Q2 = Bld::<Q2, _>::new().push_back(2).push_back('x').finish();
    let _: Q3 = Bld::<Q3, _>::new()
        .push_back(2)
        .push_back('x')
        .push_back(true)
        .finish();
...
fn with_gen() {
    ...
    let _: Q1<usize> = Bld::<usize, Q1<usize>, _>::new().push_back(2).finish();
    let _: Q2<usize> = Bld::<usize, Q2<usize>, _>::new()
        .push_back(2)
        .push_back('x')
        .finish();
...
fn with_all() {
    ...
    let _: Q1<char> = Bld::<char, Q1<char>, _>::new().push_back(2).finish();
    let _: Q2<char> = Bld::<char, Q2<char>, _>::new()
        .push_back(2)
        .push_back('x')
        .finish();
