...
fn run(c: &mut Criterion) {
    let (n, screen_as_st_queue) = st_queue_screen::new_screen_100();
    let screen_as_trait_objects = trait_objects_screen::new_screen_100();
    let screen_as_enums = enum_screen::new_screen_100();
